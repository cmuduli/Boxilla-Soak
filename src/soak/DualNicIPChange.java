...
public class DualNicIPChange extends StartupTestCase2 {

	private String extraIP;
	private SystemMethods methods = new SystemMethods();
	final static Logger log = Logger.getLogger(DualNicIPChange.class);

	public DualNicIPChange() throws IOException {
