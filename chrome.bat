...
java -cp C:\Test_Workstation\SeleniumAutomation\lib\*;C:\Test_Workstation\SeleniumAutomation\bin -Drelease=%LAST% -Dbrowser=%Browser% -Demerald=%emerald% org.testng.TestNG extraBrowser.xml
REM call ant
